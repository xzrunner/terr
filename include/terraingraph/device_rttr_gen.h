...
#define PARM_FILEPATH_PARM terraingraph/device/##PARM_DEVICE_CLASS##.parm.h
#endif

#define RTTR_NAME terraingraph::##PARM_DEVICE_NAME

rttr::registration::class_<terraingraph::device::PARM_DEVICE_CLASS>(XSTR(RTTR_NAME))
.constructor<>()
#define PARM_FILEPATH XSTR(PARM_FILEPATH_PARM)
#define PARM_NODE_CLASS terraingraph::device::##PARM_DEVICE_CLASS
